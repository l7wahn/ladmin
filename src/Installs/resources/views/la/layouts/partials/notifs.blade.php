							...
							<ul class="menu">
								<li><!-- start message -->
									<a href="#">
										<div class="pull-left">
											<!-- User Image -->
											<img src="@if(isset(Auth::user()->email)) {{ Gravatar::fallback(asset('la-assets/img/user-placeholder.jpg'))->get(Auth::user()->email) }} @else asset('/img/user-placeholder.jpg' @endif" class="img-circle" alt="User Image"/>
										</div>
				...
				@else
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="{{ Gravatar::fallback(asset('la-assets/img/user-placeholder.jpg'))->get(Auth::user()->email) }}" class="user-image" alt="User Image"/>
