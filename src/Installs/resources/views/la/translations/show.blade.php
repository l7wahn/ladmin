...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $translation->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-4">
			...
			<div class="teamview">
				...
				<a class="face" data-toggle="tooltip" data-placement="top" title="John Doe"><img src="{{ asset('la-assets/img/user-placeholder.jpg') }}" alt=""></a>
		...
		<div class="col-md-1 actions">
			@la_access("Translations", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/translations/'.$translation->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Translations", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.translations.destroy', $translation->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/translations') }}" data-toggle="tooltip" data-placement="right" title="@tslt("Back to Translations")"><i class="fa fa-chevron-left"></i></a></li>
		<li class="active"><a role="tab" data-toggle="tab" class="active" href="#tab-general-info" data-target="#tab-info"><i class="fa fa-bars"></i> @tslt("General Info")</a></li>
		<li class=""><a role="tab" data-toggle="tab" href="#tab-timeline" data-target="#tab-timeline"><i class="fa fa-clock-o"></i> @tslt("Timeline") </a></li>
	</ul>
			...
			<div class="tab-content">
				<div class="panel infolist">
					<div class="panel-default panel-heading">
						<h4>@tslt("General Info")</h4>
					</div>
					<div class="panel-body">
						@tslt("@la_display($module, 'language_id')
						@la_display($module, 'text_id')
