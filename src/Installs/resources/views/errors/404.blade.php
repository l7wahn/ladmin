...
<html>
    <head>
        <title>@tslt("Page") / @tslt("Record not found").</title>
        ...
        <div class="container">
            <div class="content">
                ...
                @if(isset($record_name) && isset($record_id))
					<div class="title">{{ __t($record_name) }} @tslt("with id") {{ $record_id }} @tslt("No fue encontrado")</div>
				@else
					<div class="title">@tslt("Page not found")</div>
				@endif
